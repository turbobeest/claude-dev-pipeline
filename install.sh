...
show_next_steps() {
    ...
    echo ""
    echo "  2. Start Phase 1 (Task Decomposition):"
    echo "     Open Claude Code in this directory and run:"
    echo "     ${CYAN}/parse-prd${NC}"
    echo ""
    echo "     ${YELLOW}Note:${NC} This will read your PRD and generate master tasks."
    echo "     For large PRDs (>25K tokens), it will use the large-file-reader."
    echo ""
